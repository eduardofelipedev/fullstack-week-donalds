...
-- DropForeignKey
ALTER TABLE "Order" DROP CONSTRAINT "Order_resrtaurantId_fkey";
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_resrtaurantId_fkey" FOREIGN KEY ("resrtaurantId") REFERENCES "Restaurant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

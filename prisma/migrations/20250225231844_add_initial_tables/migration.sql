-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'IN_PREPARATION', 'CONFIRMED', 'FINISHED', 'CANCELED', 'DELIVERED');
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_resrtaurantId_fkey" FOREIGN KEY ("resrtaurantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
